                ...
                <form method="post" action="../public/index.php?controller=UserController&action=register" class="needs-validation" novalidate>
                    ...
                    <div class="form-group">
                        <div class="form-check-inline">
                            <input class="form-check-input" type="radio" name="type" value="0" id="studentRadio" required>
                            <label class="form-check-label" for="studentRadio">
                                Student
                            </label>
                            <input class="form-check-input" type="radio" name="type" value="1" id="teacherRadio" required>
