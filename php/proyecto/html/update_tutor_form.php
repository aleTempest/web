                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="crud.php" method="post" class="needs-validation" novalidate>
                            ...
                            <div class="mb-3">
                                <input class="form-control" type="text" name="tutor_email"
                            ...
                            <div class="mb-3">
                                <select name="career_id" class="form-control">
                                    ...
                                    while ($row = $res->fetch_assoc()) {
                                        // verificar la carrera del tutor y seleccionarla igual a como se explico
                                        // en update_consulting_form.php
                            ...
                            <button class="btn btn-success" name="edit_tutor">Guardar <i
