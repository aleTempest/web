              ...
              <div class="card">
                <div class="card-body">
                  <form method="post" action="crud.php">
                    ...
                    <div class="mb-3">
                      <label for="name_student" class="form-label">Nombre</label>
                      <input name="name_student" type="text" class="form-control" id="exampleInputEmail1">
                    </div>
                    <button name="student_form_add" type="submit" class="btn btn-primary">Submit</button>
                  </form>
                </div>
              </div>
          </div>
