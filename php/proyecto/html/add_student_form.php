...
// consulta con los datos de las carreras
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="add_student.php" id="studentForm" class="needs-validation"
                                novalidate>
                                <div class="mb-3">
                                ...
                                <button name="new_student" type="submit" class="btn btn-primary">Guardar <i
