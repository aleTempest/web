                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover">
                        ...
                        while ($row = $res->fetch_assoc()) {
                            ...
                            echo '<button name="delete_career" class="btn btn-danger" value="' . $row['id_career'] . '"> <i class="fa-solid fa-trash"></i> </button> ';
                            echo '<a class="btn btn-primary" href="update_career_form.php?id=' . $row['id_career'] . '"><i class="fa-solid fa-pencil"></i></a>';
                            echo '</form></td></tr>';
                        }
                        ?>
                        </tbody>
